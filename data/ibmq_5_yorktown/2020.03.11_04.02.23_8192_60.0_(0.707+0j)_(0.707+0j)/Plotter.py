...
def plot_results(collision_number, numerical_tangle_list, tangle_lb_list, fidelity_GHZ_list, fidelity_T_list,
    ...
    ax.plot(collision_number, fidelity_GHZ_list, ls='', ms=s1, marker='+', mew=mew1, label=r'ibmq\_5\_yorktown', clip_on=False,
               color=c1, zorder=5)
    ...
    ax.set_ylabel(r'Fidelity ($F$)')
    ax.plot(numerical_tangle_list, fidelity_GHZ_list, ls='', ms=s1, marker='+', mew=mew1, label=r'ibmq\_5\_yorktown', clip_on=False,
               color=c1, zorder=5)
