...
def plot(collision_number, concurrence_list, fidelity_S_list, fidelity_T_list,
    ...
    for i in range(1, 5):
        ...
        if i == 1:
            ...
            ax.plot(collision_number, concurrence_list, ls='', ms=s1, mew=mew1, marker='x', label=r'ibmq\_5\_yorktown', clip_on=False, color=c1, zorder=5)
        ...
        if i == 2:
            ...
            ax.plot(collision_number, fidelity_S_list, ls='', ms=s1, mew=mew1, marker='x', label=r'ibmq\_5\_yorktown',
        ...
        if i == 3:
            ...
            ax.set_ylabel(r'Fidelity ($F$)')
            ax.plot(concurrence_list, fidelity_S_list, ls='', ms=s1, mew=mew1, marker='x', label=r'ibmq\_5\_yorktown',
                       clip_on=False, color=c1, zorder=5)
