...
def plot_results(collision_number, numerical_tangle_list, fidelity_GHZ_list, fidelity_T_list,
    ...
    ax.plot(collision_number, numerical_tangle_list, ls='', ms=s1, marker='x', mew=mew1, label=r'ibmq\_16\_melbourne', clip_on=False,
               c=c1, zorder=5)
...
plot_results(data['collision_number'], data['numerical_tangle_list'], data['fidelity_GHZ_list'],
