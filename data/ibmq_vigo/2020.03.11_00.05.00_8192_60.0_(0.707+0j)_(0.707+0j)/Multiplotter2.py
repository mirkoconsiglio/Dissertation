...
def plot(collision_number, numerical_tangle_list, tangle_lb_list, fidelity_GHZ_list, fidelity_T_list,
    ...
    for i in range(1, 5):
        ...
        if i == 1:
            ...
            ax.plot(collision_number, numerical_tangle_list, ls='', ms=s1, mew=mew1, marker='x', label=r'ibmq\_vigo', clip_on=False, color=c1, zorder=5)
        ...
        if i == 2:
            ...
            ax.plot(collision_number, fidelity_GHZ_list, ls='', ms=s1, mew=mew1, marker='x', label=r'ibmq\_vigo',
        ...
        if i == 3:
            ...
            ax.set_ylabel(r'Fidelity ($F$)')
            ax.plot(numerical_tangle_list, fidelity_GHZ_list, ls='', ms=s1, mew=mew1, marker='x', label=r'ibmq\_vigo',
                       clip_on=False, color=c1, zorder=5)
