...
def plot_results(collision_number, numerical_tangle_list, tangle_lb_list, fidelity_GHZ_list, fidelity_T_list,
    ...
    ax.plot(collision_number, numerical_tangle_list, ls='', ms=s1, marker='x', mew=mew1, label=r'ibmq\_vigo', clip_on=False,
               c=c1, zorder=5)
    ...
    ax.plot(collision_number, fidelity_GHZ_list, ls='', ms=s1, marker='+', mew=mew1, label=r'ibmq\_vigo', clip_on=False,
               color=c1, zorder=5)
    ...
    ax.yaxis.set_ticks(np.linspace(a, 1, int((1 - a) * 10 + 1)))
    ax.set_ylabel(r'Fidelity ($F$)')
    ax.plot(collision_number, fidelity_T_list, ls='', ms=s1, marker='+', mew=mew1, label=r'ibmq\_vigo', clip_on=False,
               color=c1, zorder=5)
    ...
    ax.set_ylabel(r'Fidelity ($F$)')
    ax.plot(numerical_tangle_list, fidelity_GHZ_list, ls='', ms=s1, marker='+', mew=mew1, label=r'ibmq\_vigo', clip_on=False,
               color=c1, zorder=5)
